        ...
        async def on_message(message):
            if self.mode == 0:
                if message.content.startswith('!criminal'):
                    self.mode = 1
                    await self.client.send_message(message.channel, "A man died in his round house. The butcher said he was chopping meat. The gardener said she was pulling weeds. The butler said he was dusting the corners. Who killed the man?")
